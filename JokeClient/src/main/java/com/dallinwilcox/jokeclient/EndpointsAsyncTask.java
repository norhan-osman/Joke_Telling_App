...
import com.dallinwilcox.jokeserver.myApi.MyApi;
...
public class EndpointsAsyncTask extends AsyncTask<Context, Void, String> {
    ...
    protected void onPostExecute(String joke) {
        Intent jokeIntent = new Intent (context.getApplicationContext(), JokeActivity.class);
        jokeIntent.putExtra(JokeActivity.JOKE_STRING, joke);
